...
vector<grue> mobs;
linkMap(rooms); //Link Rooms according to the file, And run the rooms/mobs constructor, Spawn the monsters too.
spawnLoadMobs(rooms,mobs);//Load Mobs data into vector, and spawn them + assign names.
